...
class FavoritesDB(val context: Context, factory: SQLiteDatabase.CursorFactory?): SQLiteOpenHelper(context,
    ...
    override fun onCreate(p0: SQLiteDatabase?) {
        val query = "CREATE TABLE IF NOT EXISTS Favorites($ID_COL TEXT PRIMARY KEY, $TITLE_COL TEXT, $ALBUM_COL TEXT, $ARTIST_COL TEXT, $DURATION_COL INTEGER, $PATH_COL TEXT, $ART_URI_COL TEXT, $DATE_MODIFIED_COL Text)"
        p0?.execSQL(query)
    }
