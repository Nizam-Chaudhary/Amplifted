...
class RecentRecyclerViewAdapter(val context: Context,private val songsList: ArrayList<SongsData>): RecyclerView.Adapter<RecentRecyclerViewAdapter.Holder>() {
    ...
    private fun sendIntent(position: Int) {
        ...
        intent.putExtra("class", "RecentlyPlayed")
